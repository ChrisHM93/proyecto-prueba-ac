...
import { FcSurvey, FcCancel, FcPlus } from "react-icons/fc";
import { ModalPlaning } from './ModalPlaning';
import Swal from 'sweetalert2';
import './styles/coordScreen.css';

export const CoordScreen = () => {
    ...
    return (
        <>
            <UserNavbar />
            <Banner title="Planeacion de actividades" />
                ...
                <div className="table-container">
                    <table class="table table-style text-center">
                        <thead >
                            <tr>
                                <th scope="col-1">#</th>
                                <th scope="col-2">Proyecto/Actividad</th>
                                <th scope="col-4">Recurso</th>
                                <th scope="col-1">Mes</th>
                                <th scope="col-2">Semana</th>
                                <th scope="col-2">Horas planeadas</th>
            ...
            <ModalPlaning show={ show } closeModal={ handleCloseModal } />
        </>
    )
}
